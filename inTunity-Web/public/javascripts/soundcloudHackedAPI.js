! function(t, e) {
    ...
    return function(t) {
        ...
        var i = n(1),
            r = n(26),
            o = new r({
                flashAudioPath: "<JORG GOT HACKS BRUH!!!!!!!!!!!!!!>" //[Jorg HACKED HERE]
            }),
            s = n(2),
            a = n(27);
        t.exports = function(t, e) {
        ...
        t.exports = function(t) {
            ...
            function r(t) {
                return function(e) {
                    ...
                    switch (e) {
                        case u.RTMP:
							/*Previously, it was "n = l.supportsFlash()"
							Modified it to "n = false" = disable flash for RTMP files.
							*/
                            n =false; //[JORG TAGGED HERE] WE WILL NEVER USE FLASH MODE EVER AGAIN!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                            break;
                        case u.HTTP:
